...
export class DashboardPageComponent implements OnInit {
  ...
  public repeatedDataUsers: Array<number> = [];
  public allTimeUsers: Array<number> = [];
  public mainChartData: Array<any> = [
    ...
    {
      data: this.repeatedDataUsers,
      label: 'Repeat Users'
    },
    {
      data: this.allTimeUsers,
  ...
  ngOnInit(): void {
    ...
    for (let i = 0; i <= this.mainChartElements; i++) {
      ...
      this.mainChartData2.push(this.random(80, 100));
       this.repeatedDataUsers.push(this.random(100, 150));
      this.allTimeUsers.push(this.random(50, 100))
